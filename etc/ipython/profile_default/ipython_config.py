...
if is_venv():
    ...
    ipython_cache_dir = base_dir / "var" / "cache" / "ipython"
else:
    # use the user-level cache-folder
...
c.TerminalInteractiveShell.debugger_history_file = str(ipython_cache_dir / "pdb-history")
